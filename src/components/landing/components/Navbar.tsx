...
function NavbarContent() {
  ...
  return (
    <nav className="bg-black/90 backdrop-blur-md fixed w-full z-50 top-0 inset-s-0 border-b border-white/10 h-16 flex items-center font-sans">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-3 items-center w-full">
