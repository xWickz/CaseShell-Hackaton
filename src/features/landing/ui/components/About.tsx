...
import { CyberGridBg } from "@/features/landing/ui/cyberGrid";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-20 py-24 md:py-32">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-8 text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl text-snow-white font-semibold tracking-tighter font-mono flex flex-wrap justify-center lg:justify-start items-center gap-2">
                ¿Qué es Case <CanvasTxt text="Shell" />?
              </h2>

              <p className="text-md md:text-md text-zinc-300 leading-relaxed max-w-lg mx-auto lg:mx-0 text-justify">
            ...
            <div className="relative group w-full max-w-2xl mx-auto">
              <div className="relative overflow-hidden rounded-md border border-white/10 bg-zinc-950/40 backdrop-blur-sm shadow-2xl">
                <Image
                  src="/demo_gif_02.gif"
                  width={700}
                  height={550}
