        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-20 py-24 md:py-32">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-8 text-center lg:text-left">
              <h2 className="text-4xl md:text-6xl text-snow-white/90 font-bold tracking-tighter flex flex-wrap justify-center lg:justify-start items-center gap-2">
                The Ultimate Terminal Puzzle
              </h2>

              <p className="text-md md:text-md text-slate-300 leading-relaxed max-w-lg mx-auto lg:mx-0 text-justify font-semibold">
